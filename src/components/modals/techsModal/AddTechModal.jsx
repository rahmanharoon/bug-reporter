...
import { addTechs } from "../../../redux/actions/techActions";
...
const AddTechModal = ({ addTechs }) => {
  ...
  const onSubmit = () => {
    if (firstName === "" || lastName === "") {
      M.toast({
        html: "Please enter the First name and Last Name of technician",
      });
    } else {
      addTechs({
        firstName,
      ...
      M.toast({
        html: `New technician ${firstName} ${lastName} is added`,
      });
      setFirstName("");
      setLastName("");
    }
